...
impl TryFrom<JoystickConfig> for Joystick {
    type Error = AnyError;

    fn try_from(config: JoystickConfig) -> AnyResult<Self> {
        ...
        Ok(Joystick {
            ...
            technique: config
                .technique
                .try_into()
                .context("Failed to initialize driving joystick handling technique")?,
        })
    }
}
